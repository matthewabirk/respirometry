...
#' @seealso \code{\link{min_flow}}, \code{\link{flush}}
#' 
#' @examples
#' max_MO2(flow_rate = 1)
#' 
#' # What is the maximum MO2 organism I can place in my respirometer and still maintain at least 75% air saturation when the intake fresh water is 1.5 LPM, 10 °C and 90% air saturated?
