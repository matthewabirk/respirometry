...
#' min_flow(MO2 = 1000)
#' 
#' # What is the minimum flow rate required to maintain at least 75% air saturation in a respirometer with an organism(s) with an oxygen consumption rate of 1000 umol/h when the intake fresh water is 10 °C and 90% air saturated?
...
min_flow = function(MO2, min_pO2 = 90, pO2_in = 100, temp = 25, sal = 35, atm_pres = 1013.25){
	o2_conc = as.numeric(marelac::gas_satconc(S = sal, t = temp, P = birk::conv_unit(atm_pres, 'mbar', 'bar'), species = 'O2'))
